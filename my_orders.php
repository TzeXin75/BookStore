...
// Fetch orders for the current user most-recent-first
...
<body>
    ...
    <main style="max-width: 1200px; margin: 40px auto; padding: 20px; min-height: 60vh;">
            ...
            <!-- Orders Table: lists recent orders for the logged-in user -->
                        ...
                        <?php foreach ($orders as $order): ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <?php 
                                    // Pick a color for status badges using PHP 8 match expression
                                ...
                                <!-- Action: view order details page -->
